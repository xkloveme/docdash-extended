...
var categories = require('docdash-extended-xkloveme/categories.js');
...
function buildNav(members, categoriesMembers) {
    ...
    var defaultOrder = ['Categories', 'Classes', 'Modules', 'Externals', 'Events', 'Namespaces', 'Mixins', 'Tutorials', 'Interfaces', 'Global'];
